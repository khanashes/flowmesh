...
func TestStreamService_WriteEvents(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		service := NewStreamService(mockStorage)
		...
		resp, err := service.WriteEvents(context.Background(), req)
		require.NoError(t, err)
		assert.Equal(t, int32(codes.OK), resp.Status.Code)
		assert.Len(t, resp.Offsets, 3)
		assert.Equal(t, int64(0), resp.Offsets[0])
	})

	t.Run("invalid resource path", func(t *testing.T) {
		service := NewStreamService(&mockStreamStorage{})

		req := &flowmeshpb.WriteEventsRequest{
			ResourcePath: nil,
		}

		_, err := service.WriteEvents(context.Background(), req)
		assert.Error(t, err)
	...
	t.Run("stream not found", func(t *testing.T) {
		mockStorage := &mockStreamStorage{
			writeEventsFunc: func(ctx context.Context, resourcePath string, events []storage.StreamEvent) ([]int64, error) {
				return nil, streamserrors.StreamNotFoundError{ResourcePath: resourcePath}
			},
		}
		service := NewStreamService(mockStorage)
...
func TestStreamService_ReadStream(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		mockStorage := &mockStreamStorage{
		...
		resp, err := service.ReadStream(context.Background(), req)
		require.NoError(t, err)
		assert.Equal(t, int32(codes.OK), resp.Status.Code)
	...
	t.Run("invalid offset", func(t *testing.T) {
		...
		_, err := service.ReadStream(context.Background(), req)
		assert.Error(t, err)
		st, ok := status.FromError(err)
		require.True(t, ok)
		assert.Equal(t, codes.InvalidArgument, st.Code())
...
func TestStreamService_CommitOffset(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		mockStorage := &mockStreamStorage{
		...
		resp, err := service.CommitOffset(context.Background(), req)
		require.NoError(t, err)
		assert.Equal(t, int32(codes.OK), resp.Status.Code)
	})
	...
	t.Run("invalid offset", func(t *testing.T) {
		...
		_, err := service.CommitOffset(context.Background(), req)
		assert.Error(t, err)
		st, ok := status.FromError(err)
		require.True(t, ok)
		assert.Equal(t, codes.InvalidArgument, st.Code())
...
func TestStreamService_GetOffset(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		mockStorage := &mockStreamStorage{
		...
		resp, err := service.GetOffset(context.Background(), req)
		require.NoError(t, err)
		assert.Equal(t, int32(codes.OK), resp.Status.Code)
...
func TestStreamService_GetLatestOffset(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		mockStorage := &mockStreamStorage{
		...
		resp, err := service.GetLatestOffset(context.Background(), req)
		require.NoError(t, err)
		assert.Equal(t, int32(codes.OK), resp.Status.Code)
...
func TestStreamService_GetConsumerGroupState(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		mockStorage := &mockStreamStorage{
		...
		resp, err := service.GetConsumerGroupState(context.Background(), req)
		require.NoError(t, err)
		assert.Equal(t, int32(codes.OK), resp.Status.Code)
