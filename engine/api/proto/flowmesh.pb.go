...
type Schema struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                 // Schema identifier
	Type          string                 `protobuf:"bytes,2,opt,name=type,proto3" json:"type,omitempty"`                             // Schema type (e.g., "jsonschema")
	Version       int32                  `protobuf:"varint,3,opt,name=version,proto3" json:"version,omitempty"`                      // Schema version
	Definition    []byte                 `protobuf:"bytes,4,opt,name=definition,proto3" json:"definition,omitempty"`                 // Schema definition (JSON)
	CreatedAt     int64                  `protobuf:"varint,5,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"` // Creation timestamp (Unix nanoseconds)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Schema) Reset() {
	*x = Schema{}
	mi := &file_flowmesh_proto_msgTypes[56]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Schema) Descriptor() ([]byte, []int) {
	return file_flowmesh_proto_rawDescGZIP(), []int{56}
}
...
// RegisterSchemaRequest is a request to register a schema
type RegisterSchemaRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tenant        string                 `protobuf:"bytes,1,opt,name=tenant,proto3" json:"tenant,omitempty"`                           // Tenant identifier
	SchemaId      string                 `protobuf:"bytes,2,opt,name=schema_id,json=schemaId,proto3" json:"schema_id,omitempty"`       // Schema identifier
	SchemaType    string                 `protobuf:"bytes,3,opt,name=schema_type,json=schemaType,proto3" json:"schema_type,omitempty"` // Schema type (e.g., "jsonschema")
	Version       int32                  `protobuf:"varint,4,opt,name=version,proto3" json:"version,omitempty"`                        // Schema version
	Definition    []byte                 `protobuf:"bytes,5,opt,name=definition,proto3" json:"definition,omitempty"`                   // Schema definition (JSON)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RegisterSchemaRequest) Reset() {
	*x = RegisterSchemaRequest{}
	mi := &file_flowmesh_proto_msgTypes[57]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegisterSchemaRequest) Descriptor() ([]byte, []int) {
	return file_flowmesh_proto_rawDescGZIP(), []int{57}
}

func (x *RegisterSchemaRequest) GetTenant() string {
	if x != nil {
		return x.Tenant
	}
	return ""
...
func (x *RegisterSchemaRequest) GetDefinition() []byte {
	if x != nil {
		return x.Definition
	}
	return nil
...
// RegisterSchemaResponse is a response to registering a schema
...
func (x *RegisterSchemaResponse) Reset() {
	*x = RegisterSchemaResponse{}
	mi := &file_flowmesh_proto_msgTypes[58]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegisterSchemaResponse) Descriptor() ([]byte, []int) {
	return file_flowmesh_proto_rawDescGZIP(), []int{58}
}

func (x *RegisterSchemaResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
// GetSchemaRequest is a request to get a schema
type GetSchemaRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tenant        string                 `protobuf:"bytes,1,opt,name=tenant,proto3" json:"tenant,omitempty"`                     // Tenant identifier
	SchemaId      string                 `protobuf:"bytes,2,opt,name=schema_id,json=schemaId,proto3" json:"schema_id,omitempty"` // Schema identifier
	Version       int32                  `protobuf:"varint,3,opt,name=version,proto3" json:"version,omitempty"`                  // Schema version (0 = latest)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetSchemaRequest) Reset() {
	*x = GetSchemaRequest{}
	mi := &file_flowmesh_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSchemaRequest) Descriptor() ([]byte, []int) {
	return file_flowmesh_proto_rawDescGZIP(), []int{59}
}
...
// GetSchemaResponse is a response to getting a schema
type GetSchemaResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        *Status                `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"` // Operation status
	Schema        *Schema                `protobuf:"bytes,2,opt,name=schema,proto3" json:"schema,omitempty"` // Schema definition
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetSchemaResponse) Reset() {
	*x = GetSchemaResponse{}
	mi := &file_flowmesh_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSchemaResponse) Descriptor() ([]byte, []int) {
	return file_flowmesh_proto_rawDescGZIP(), []int{60}
}

func (x *GetSchemaResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
// ListSchemasRequest is a request to list schemas
type ListSchemasRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tenant        string                 `protobuf:"bytes,1,opt,name=tenant,proto3" json:"tenant,omitempty"`                     // Tenant identifier
	SchemaId      string                 `protobuf:"bytes,2,opt,name=schema_id,json=schemaId,proto3" json:"schema_id,omitempty"` // Optional schema ID filter (empty = all schemas)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListSchemasRequest) Reset() {
	*x = ListSchemasRequest{}
	mi := &file_flowmesh_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSchemasRequest) Descriptor() ([]byte, []int) {
	return file_flowmesh_proto_rawDescGZIP(), []int{61}
}

func (x *ListSchemasRequest) GetTenant() string {
	if x != nil {
		return x.Tenant
	}
	return ""
...
func (x *ListSchemasRequest) GetSchemaId() string {
	if x != nil {
		return x.SchemaId
	}
	return ""
...
// ListSchemasResponse is a response to listing schemas
type ListSchemasResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        *Status                `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`   // Operation status
	Schemas       []*Schema              `protobuf:"bytes,2,rep,name=schemas,proto3" json:"schemas,omitempty"` // List of schemas
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListSchemasResponse) Reset() {
	*x = ListSchemasResponse{}
	mi := &file_flowmesh_proto_msgTypes[62]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListSchemasResponse) Descriptor() ([]byte, []int) {
	return file_flowmesh_proto_rawDescGZIP(), []int{62}
}

func (x *ListSchemasResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
// DeleteSchemaRequest is a request to delete a schema
...
func (x *DeleteSchemaRequest) Reset() {
	*x = DeleteSchemaRequest{}
	mi := &file_flowmesh_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteSchemaRequest) Descriptor() ([]byte, []int) {
	return file_flowmesh_proto_rawDescGZIP(), []int{63}
}

func (x *DeleteSchemaRequest) GetTenant() string {
	if x != nil {
		return x.Tenant
	}
	return ""
...
// DeleteSchemaResponse is a response to deleting a schema
...
func (x *DeleteSchemaResponse) Reset() {
	*x = DeleteSchemaResponse{}
	mi := &file_flowmesh_proto_msgTypes[64]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteSchemaResponse) Descriptor() ([]byte, []int) {
	return file_flowmesh_proto_rawDescGZIP(), []int{64}
}

func (x *DeleteSchemaResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
// SetResourceSchemaRequest is a request to set a schema on a resource
type SetResourceSchemaRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ResourcePath  *ResourcePath          `protobuf:"bytes,1,opt,name=resource_path,json=resourcePath,proto3" json:"resource_path,omitempty"` // Resource path
	SchemaId      string                 `protobuf:"bytes,2,opt,name=schema_id,json=schemaId,proto3" json:"schema_id,omitempty"`             // Schema identifier
	Version       int32                  `protobuf:"varint,3,opt,name=version,proto3" json:"version,omitempty"`                              // Schema version (0 = latest)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SetResourceSchemaRequest) Reset() {
	*x = SetResourceSchemaRequest{}
	mi := &file_flowmesh_proto_msgTypes[65]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetResourceSchemaRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetResourceSchemaRequest) ProtoMessage() {}

func (x *SetResourceSchemaRequest) ProtoReflect() protoreflect.Message {
	mi := &file_flowmesh_proto_msgTypes[65]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetResourceSchemaRequest.ProtoReflect.Descriptor instead.
func (*SetResourceSchemaRequest) Descriptor() ([]byte, []int) {
	return file_flowmesh_proto_rawDescGZIP(), []int{65}
}

func (x *SetResourceSchemaRequest) GetResourcePath() *ResourcePath {
	if x != nil {
		return x.ResourcePath
	}
	return nil
...
func (x *SetResourceSchemaRequest) GetSchemaId() string {
	if x != nil {
		return x.SchemaId
	}
	return ""
...
func (x *SetResourceSchemaRequest) GetVersion() int32 {
	if x != nil {
		return x.Version
	}
	return 0
...
// SetResourceSchemaResponse is a response to setting a schema on a resource
type SetResourceSchemaResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        *Status                `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"` // Operation status
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SetResourceSchemaResponse) Reset() {
	*x = SetResourceSchemaResponse{}
	mi := &file_flowmesh_proto_msgTypes[66]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SetResourceSchemaResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetResourceSchemaResponse) ProtoMessage() {}

func (x *SetResourceSchemaResponse) ProtoReflect() protoreflect.Message {
	mi := &file_flowmesh_proto_msgTypes[66]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetResourceSchemaResponse.ProtoReflect.Descriptor instead.
func (*SetResourceSchemaResponse) Descriptor() ([]byte, []int) {
	return file_flowmesh_proto_rawDescGZIP(), []int{66}
}

func (x *SetResourceSchemaResponse) GetStatus() *Status {
	if x != nil {
		return x.Status
	}
	return nil
...
const file_flowmesh_proto_rawDesc = "" +
	...
	"\x04keys\x18\x02 \x03(\tR\x04keys\"\x85\x01\n" +
	"\x06Schema\x12\x0e\n" +
	...
	"definition\x12\x1d\n" +
	"\n" +
	"created_at\x18\x05 \x01(\x03R\tcreatedAt\"\xa7\x01\n" +
	"\x15RegisterSchemaRequest\x12\x16\n" +
	...
	"\x06status\x18\x01 \x01(\v2\x13.flowmesh.v1.StatusR\x06status\x12+\n" +
	"\x06schema\x18\x02 \x01(\v2\x13.flowmesh.v1.SchemaR\x06schema\"I\n" +
	"\x12ListSchemasRequest\x12\x16\n" +
	"\x06tenant\x18\x01 \x01(\tR\x06tenant\x12\x1b\n" +
	"\tschema_id\x18\x02 \x01(\tR\bschemaId\"q\n" +
	"\x13ListSchemasResponse\x12+\n" +
	"\x06status\x18\x01 \x01(\v2\x13.flowmesh.v1.StatusR\x06status\x12-\n" +
	"\aschemas\x18\x02 \x03(\v2\x13.flowmesh.v1.SchemaR\aschemas\"d\n" +
	"\x13DeleteSchemaRequest\x12\x16\n" +
	"\x06tenant\x18\x01 \x01(\tR\x06tenant\x12\x1b\n" +
	"\tschema_id\x18\x02 \x01(\tR\bschemaId\x12\x18\n" +
	"\aversion\x18\x03 \x01(\x05R\aversion\"C\n" +
	"\x14DeleteSchemaResponse\x12+\n" +
	"\x06status\x18\x01 \x01(\v2\x13.flowmesh.v1.StatusR\x06status\"\x91\x01\n" +
	"\x18SetResourceSchemaRequest\x12>\n" +
	"\rresource_path\x18\x01 \x01(\v2\x19.flowmesh.v1.ResourcePathR\fresourcePath\x12\x1b\n" +
	"\tschema_id\x18\x02 \x01(\tR\bschemaId\x12\x18\n" +
	...
	"\bListKeys\x12\x1c.flowmesh.v1.ListKeysRequest\x1a\x1d.flowmesh.v1.ListKeysResponse2\xc1\x03\n" +
	"\rSchemaService\x12Y\n" +
	"\x0eRegisterSchema\x12\".flowmesh.v1.RegisterSchemaRequest\x1a#.flowmesh.v1.RegisterSchemaResponse\x12J\n" +
...
var file_flowmesh_proto_goTypes = []any{
	...
	(*Schema)(nil),                        // 56: flowmesh.v1.Schema
	(*RegisterSchemaRequest)(nil),         // 57: flowmesh.v1.RegisterSchemaRequest
	(*RegisterSchemaResponse)(nil),        // 58: flowmesh.v1.RegisterSchemaResponse
	(*GetSchemaRequest)(nil),              // 59: flowmesh.v1.GetSchemaRequest
	(*GetSchemaResponse)(nil),             // 60: flowmesh.v1.GetSchemaResponse
	(*ListSchemasRequest)(nil),            // 61: flowmesh.v1.ListSchemasRequest
	(*ListSchemasResponse)(nil),           // 62: flowmesh.v1.ListSchemasResponse
	(*DeleteSchemaRequest)(nil),           // 63: flowmesh.v1.DeleteSchemaRequest
